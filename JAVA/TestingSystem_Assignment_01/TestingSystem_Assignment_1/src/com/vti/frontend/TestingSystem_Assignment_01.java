...
//  QUESTION 3: IN 1 DOI TUONG RA MAN HINH
		...
		System.out.println("ID: " + groupaccount1.id.id);
		System.out.println("AccounId: " + groupaccount1.accountId.fullName);
		...
		System.out.println("CategoryID: " + question01.categoryId.id);
		System.out.println("TypeID: " + question01.typeId.id);
		System.out.println("Nguoi tao: " + question01.accountId.fullName);
		...
		System.out.println("QuestionId: " + answer01.questionId.id);
		...
		System.out.println("CategoryId: " + exam01.categoryId.id);
		System.out.println("Duration: " + exam01.duration);
		System.out.println("CreateId: " + exam01.creatorId.fullName);
		System.out.println("Ngay tao: " + exam01.createDate);
		
		System.out.println("_____________________");

		System.out.println("In thong tin EXAMQUESTION");
		System.out.println("ID: " + examquestion01.examId.id);
		System.out.println("QuestionId: " + examquestion01.questionId.id);
	}
}
