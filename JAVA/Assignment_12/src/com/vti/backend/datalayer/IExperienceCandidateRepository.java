...
/**
 * This class is interface IExperienceCandidateRepository
 * 
 * @Description: .
...
public interface IExperienceCandidateRepository {
	...
	public Boolean updateExperienceCandidate(String password, String email) throws ClassNotFoundException, SQLException;
